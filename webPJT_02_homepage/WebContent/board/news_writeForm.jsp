...
%>  <!-- 이런 경우에는 common.java에서 type에 Static 없어도 됨  -->

<!--   위에서 import도 common 도 생성을 안하고 사용하는 방법 : 아래 value 에 "<%-- <%=common.common.getToday() %> --%>"라고 입력해도 됨(common.java에서 type에 static이 들어갔기 때문에 가능함) -->
<!DOCTYPE html>
<html>
<head>
	<title>노호진</title>
