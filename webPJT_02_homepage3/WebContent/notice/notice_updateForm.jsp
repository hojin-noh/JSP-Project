...
#content {
	width: 748px; 
	height : 500px;   /* height에 주석을 달아 놓으면 테이블 안에 들어있는 텍스트 상자에 맞춰서 크기 조절됨 */
	padding: 20px;
	margin-bottom: 20px;
	float: right;
	border: 0px solid #bcbcbc;
	...
	color :#848484; 
	  ...
	  <div class="bord_list">
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="3">
						...
						System.out.print(dto.getAttach()); 
						}%>
						<br>
				...
				<tr>
					<th>등록자</th>
					<td>
						<input type="text"  size="5" value=<%=dto.getReg_name()%> name="t_reg_name"> 
					</td>
					<th>등록일</th>
					<td>
						<input type="date" value="<%=dao.getToday() %>" value=<%=dto.getReg_date()%> size="5" name="t_reg_date"> 
					</td>
				</tr>
			</tbody>
		</table>
		...
		<div class="paging">
			...
			<a href="javascript:goUpdate()" class="btn_write">수정 후 저장</a>
		</div>
	  </div>			
