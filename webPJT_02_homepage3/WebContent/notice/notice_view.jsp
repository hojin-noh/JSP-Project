...
//	dao.hitCount(no); Notice_dao.java 에 viewNotice 메소드에서 작동시키면 필요없음
...
<form name="noti">
		...
		<div class="paging">
			...
			<a href="notice_updateForm.jsp?t_no=<%=no%>" class="btn_write">수 정GET</a>
			<a href="javascript:goUpdate()" class="btn_write">수 정POST</a>
