					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								...
								<td colspan="3"><input type="text" name="t_question" id="title" value="<%=dto.getQuestion() %>" class="title"></td>
							</tr>
							
							<tr>
								<th><label for="cont">내용</label></th>
								<td colspan="3"><textarea type="cont" name="t_answer" id="cont" value="<%=dto.getAnswer() %>" class="cont"></textarea>
							</tr>
